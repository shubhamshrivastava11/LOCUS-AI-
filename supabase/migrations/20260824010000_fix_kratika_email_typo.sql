...
--
-- Fixes a typo in 20260824000000: 'kratikaixit3@gmail.com' was wrong,
-- the correct address is 'kratikadixit3@gmail.com' (missing the 'd' in
-- Dixit). Nobody ever signed up under the mistyped address (checked
-- auth.users - zero rows), so this is a pure allowlist correction, no
-- account cleanup needed alongside it.
